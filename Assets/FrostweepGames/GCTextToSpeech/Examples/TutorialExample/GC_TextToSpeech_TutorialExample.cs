...
namespace FrostweepGames.Plugins.GoogleCloud.TextToSpeech
{
    public class GC_TextToSpeech_TutorialExample : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            Debug.Log(Enumerators.LanguageCode.en_US.ToString());
            Debug.Log(Enumerators.VoiceType.WAVENET.ToString());
        ...
        private void SynthesizeButtonOnClickHandler()
        {
            ...
            Debug.Log(_currentVoice.ssmlGender);
            Debug.Log(_currentVoice.languageCodes[0]);
            Debug.Log(_currentVoice.name);
            Debug.Log(ssmlToggle.isOn);
